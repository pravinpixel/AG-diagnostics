...
if (!function_exists('insertApiPackagesData')) {
...
if (!function_exists('insertApiHomeVisitAreaData')) {
...
if (!function_exists('insertApiSampleCollectionCentersData')) {
...
if (!function_exists('clientApiDataPass')) {
