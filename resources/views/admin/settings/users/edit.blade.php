...
@section('admin_settings_content')
    <div class="card custom">
        ...
        <div class="card-body"> 
            {!! Form::model($user,['route' => ['user.update', $user->id], 'class'=>'needs-validation','novalidate','id' => 'role_user_form', 'method'=> 'put']) !!}
                @csrf
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-10">
                        {!! Form::select('role_id',$roleDb , $userRole, ['class' =>'form-select','required', 'placeholder' => '-- Select Role --'])  !!}
                    </div>
                </div>
                <div class="row ">
