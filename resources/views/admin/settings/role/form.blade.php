...
<table class="table table-bordered table-centered  tr-sm table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><input type="checkbox" {{ $permissions['user.add.manage_country'] == 'true' ?  "checked" : ""}} value="true" class="add form-check-input" name="user.add.manage_country"></td>
            <td><input type="checkbox" {{ $permissions['user.edit.manage_country'] == 'true' ?  "checked" : ""}} value="true" class="edit form-check-input" name="user.edit.manage_country"></td>
        ...
        <tr>
            ...
            <td><input type="checkbox" {{ $permissions['user.add.manage_state'] == 'true' ?  "checked" : ""}} value="true" class="add form-check-input" name="user.add.manage_state"></td>
            <td><input type="checkbox" {{ $permissions['user.edit.manage_state'] == 'true' ?  "checked" : ""}} value="true" class="edit form-check-input" name="user.edit.manage_state"></td>
        ...
        <tr>
            ...
            <td><input type="checkbox" {{ $permissions['user.add.manage_city'] == 'true' ?  "checked" : ""}} value="true" class="add form-check-input" name="user.add.manage_city"></td>
            <td><input type="checkbox" {{ $permissions['user.edit.manage_city'] == 'true' ?  "checked" : ""}} value="true" class="edit form-check-input" name="user.edit.manage_city"></td>
        ...
        <tr>
            ...
            <td><input type="checkbox" {{ $permissions['user.add.home_visit'] == 'true' ?  "checked" : ""}} value="true" class="add form-check-input" name="user.add.home_visit"></td>
            <td><input type="checkbox" {{ $permissions['user.edit.home_visit'] == 'true' ?  "checked" : ""}} value="true" class="edit form-check-input" name="user.edit.home_visit"></td>
        ...
        <tr>
            ...
            <td><input type="checkbox" {{ $permissions['user.add.packages'] == 'true' ?  "checked" : ""}} value="true" class="add form-check-input" name="user.add.packages"></td>
            <td><input type="checkbox" {{ $permissions['user.edit.packages'] == 'true' ?  "checked" : ""}} value="true" class="edit form-check-input" name="user.edit.packages"></td>
        ...
        <tr>
            ...
            <td><input type="checkbox" {{ $permissions['user.add.careers'] == 'true' ?  "checked" : ""}} value="true" class="add form-check-input" name="user.add.careers"></td>
            <td><input type="checkbox" {{ $permissions['user.edit.careers'] == 'true' ?  "checked" : ""}} value="true" class="edit form-check-input" name="user.edit.careers"></td>
        ...
        <tr>
            ...
            <td><input type="checkbox" {{ $permissions['user.add.contact_us'] == 'true' ?  "checked" : ""}} value="true" class="add form-check-input" name="user.add.contact_us"></td>
            <td><input type="checkbox" {{ $permissions['user.edit.contact_us'] == 'true' ?  "checked" : ""}} value="true" class="edit form-check-input" name="user.edit.contact_us"></td>
